...
| 作業内容  | 作業詳細 | 課題 | 解決策 |
| ------------- | ------------- | ------------- | ------------- |
| VBAにてマクロの作成  | Auクライアント先の業務効率化の為ヒアリングを行った後にマクロの作成、結果的に２時間程度かかっていたタスクを10分程度で完了させることに成功 | ------------- | ------------- |
  
#### ●デンソーウェーブのパッケージソフト（IoT Data Share、IoT Data View）を使い工場システムのみえる化を実施（1年）

| 作業内容  | 作業詳細 | 課題 | 解決策 |
| ------------- | ------------- | ------------- | ------------- |
| 工場システムのエラー箇所を画面上で把握できるようにできるシステムの作成  | 工場のシステム環境をみえる化  | 必要な箇所にはスクリプトを埋め込み対応（VBScript） | ３つの工場を並行して開発を実施 |

#### ●プロジェクトマネージャーとしてサーバリプレイスプロジェクトへの参画（3ヵ月）

| 作業内容  | 作業詳細 | 課題 | 解決策 |
| ------------- | ------------- | ------------- | ------------- |
| 課題打ち合わせ  | Content Cell  | ------------- | ------------- |
| 概算費用の算定、およびレビュー  | Content Cell  | ------------- | ------------- |
| ベンダーとのミーティング  | リモートでPCを繋ぎ作業を実施、VMware内での作業も経験  | ------------- | ------------- |
| 開発用テナントの検討および選定 | ------------- | ------------- |
