...
| 作業内容  | 作業詳細 | 課題 | 解決策 |
| ------------- | ------------- | ------------- | ------------- |
| HP改修に伴う影響調査  | HPを改修する際に発生する影響や不具合などを確認するため、定義している変数名やメソッド名からファイルの中身を確認した  | ------------- | ------------- |
...
| レビューの実施 | テスト結果をエビデンスと共に資料にまとめ、上司へレビューを実施 | ------------- |
| 本番サーバへのデプロイ | レビューに通ったPGを本番サーバーへデプロイするためLINUX環境へ入りトリプルチェックのもとデプロイを実施 | ------------- |
